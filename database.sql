...
INSERT INTO "public"."koala_hola"("id", "name", "gender", "age", "ready_to_transfer", "notes") VALUES(5, 'Charlie', 'M', 9, TRUE, 'Favorite band in Nirvana') RETURNING "id", "name", "gender", "age", "ready_to_transfer", "notes";
INSERT INTO "public"."koala_hola"("id", "name", "gender", "age", "ready_to_transfer", "notes") VALUES(6, 'Betsy', 'F', 4, TRUE, 'Has a pet iguana') RETURNING "id", "name", "gender", "age", "ready_to_transfer", "notes";